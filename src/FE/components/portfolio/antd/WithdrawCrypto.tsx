...
const getWithdrawCryptoMethod =async () => {
  message.destroy()
  ...
  const res = await fetch(URLresolve("/api/generateWithdrawMethod"),{method:"POST",mode:"no-cors",body:JSON.stringify({asset:symbol})})
    ...
    <>
      ...
      >
        <div className=" flex justify-between w-[80%] items-center">
          ...
          <button className="bg-black text-white  h-fit px-4 py-2" onClick={getWithdrawCryptoMethod}>Select</button>
        </div>
